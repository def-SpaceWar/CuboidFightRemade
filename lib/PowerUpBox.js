class PowerUpBox {
    constructor(x, y) {
        this.powerUps = [regeneration(10, 5), fasterAttack(10, 4), moreDamage(8, 3), regeneration(3, 10), jumpBoost(20, 2)];
...
function jumpBoost(time, level) {
    return (player) => {
        ...
        GameConsole.debug("Player " + player.playerNum + " got Jump Boost!");
